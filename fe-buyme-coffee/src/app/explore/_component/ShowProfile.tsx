...
export const ShowProfile = ({
  ...
  return (
    <div className="w-[909px] rounded-2xl border border-gray-300 p-6 flex flex-col gap-6 mx-auto">
      <div className="flex justify-between">
        ...
        <Link href={`/profiles/${userId}`}>
          <Button>
            <Layers2 /> View profile
          </Button>
        </Link>
      </div>
      <div className="flex">
        <div className="flex flex-1 flex-col">
          <h5 className="font-black">About {profileName}</h5>
          <p>{about}</p>
        </div>
        <div className="flex flex-1 flex-col">
          <h5 className="font-black">Social media URL</h5>
          <p>{socialMediaURL}</p>
        </div>
      </div>
    </div>
